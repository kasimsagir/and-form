...
public struct ZCRM_MOBILE_FORM_WS_ZcrmSCreateBpWs {
    public var NameFirst: String //String //char40
    ...
    public var Approval: String //ZCRM_MOBILE_FORM_WS_String //char1
    public var Country: String //ZCRM_MOBILE_FORM_WS_char3
    public var Region: String //ZCRM_MOBILE_FORM_WS_char3
    public var City: String //ZCRM_MOBILE_FORM_WS_String //char40
    public var County: String //ZCRM_MOBILE_FORM_WS_String //char40
    public var Street: String //ZCRM_MOBILE_FORM_WS_char60
    public var HouseNo: String //ZCRM_MOBILE_FORM_WS_String //char10
    public var PostCode: String //ZCRM_MOBILE_FORM_WS_String //char10
    public var Township: String //ZCRM_MOBILE_FORM_WS_String //char40
    public var DaireTip1: String //ZCRM_MOBILE_FORM_WS_String //char1
    public var DaireTip2: String //ZCRM_MOBILE_FORM_WS_String //char1
    public var DaireTip3: String //ZCRM_MOBILE_FORM_WS_String //char1
    public var DaireTip4: String //ZCRM_MOBILE_FORM_WS_String //char1
    public var DaireTip5: String //ZCRM_MOBILE_FORM_WS_String //char1
    public var SatinAmac: String //ZCRM_MOBILE_FORM_WS_char2
    public var OdemeTercih: String //ZCRM_MOBILE_FORM_WS_char2
    public var AnaKaynak: String //ZCRM_MOBILE_FORM_WS_char3
    public var Kaynak: String //ZCRM_MOBILE_FORM_WS_char3
}
...
public struct ZCRM_MOBILE_FORM_WS_ZcrmGetFieldShWs {
    public var IvAnaKaynak: String //ZCRM_MOBILE_FORM_WS_char3?
...
extension ZCRM_MOBILE_FORM_WS_ZcrmSCreateBpWs: ExpressibleByXML, XSDType {
    public init?(xml: Fuzi.XMLElement) {
        do {
            ...
            self.DaireTip5 = try parseXSDType(xml.children(staticTag: "DaireTip5"))
            ...
            self.AnaKaynak = try parseXSDType(xml.children(staticTag: "AnaKaynak"))
            self.Kaynak = try parseXSDType(xml.children(staticTag: "Kaynak"))
        } catch _ {
            return nil
        }
    }
...
extension ZCRM_MOBILE_FORM_WS_ZcrmGetFieldShWs: ExpressibleByXML, XSDType {
    public init?(xml: Fuzi.XMLElement) {
        do {
            self.IvAnaKaynak = try parseXSDType(xml.children(staticTag: "IvAnaKaynak"))
